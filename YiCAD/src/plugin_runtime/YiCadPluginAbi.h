...
#define YICAD_PLUGIN_ABI_VERSION UINT32_C(1)
...
YICAD_ABI_STATIC_ASSERT(sizeof(YiCadHostApi) == 88, "unexpected Win64 host ABI");
YICAD_ABI_STATIC_ASSERT(
    YICAD_ABI_ALIGNOF(YiCadHostApi) == 8,
    "unexpected Win64 host ABI alignment");
YICAD_ABI_STATIC_ASSERT(
    offsetof(YiCadHostApi, registerExportFilter) == 80,
    "unexpected Win64 host ABI tail offset");
YICAD_ABI_STATIC_ASSERT(sizeof(YiCadPluginApi) == 32, "unexpected Win64 plugin ABI");
YICAD_ABI_STATIC_ASSERT(
    YICAD_ABI_ALIGNOF(YiCadPluginApi) == 8,
    "unexpected Win64 plugin ABI alignment");
#elif defined(_WIN32) && UINTPTR_MAX == UINT32_MAX
YICAD_ABI_STATIC_ASSERT(sizeof(YiCadHostApi) == 48, "unexpected Win32 host ABI");
YICAD_ABI_STATIC_ASSERT(
    YICAD_ABI_ALIGNOF(YiCadHostApi) == 4,
    "unexpected Win32 host ABI alignment");
YICAD_ABI_STATIC_ASSERT(
    offsetof(YiCadHostApi, registerExportFilter) == 44,
    "unexpected Win32 host ABI tail offset");
YICAD_ABI_STATIC_ASSERT(sizeof(YiCadPluginApi) == 20, "unexpected Win32 plugin ABI");
YICAD_ABI_STATIC_ASSERT(
